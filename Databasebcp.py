...
class BookModel(Base):
    ...
    def __init__(self, title, authors, ISBN, pages, genre = "", publisher = "", imageURL = "", grade = 0, location = ""):
        self.title = title
...
def saveBook(book):
    bookModel = BookModel(book.getTitle(), book.getAuthorsStr(), book.getIsbn(), book.getNbPages(), "", book.getPublisher(), book.getImageURL(), 0, "")
